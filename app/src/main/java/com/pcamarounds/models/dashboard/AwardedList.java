...
public class AwardedList {
    ...
    @SerializedName("tech_name_last")
    @Expose
    private String tech_name_last;

    @SerializedName("wroking_days")
    @Expose
    private long wrokingDays;
    ...
    public String getTech_name_last() {
        return tech_name_last;
    }

    public void setTech_name_last(String tech_name_last) {
        this.tech_name_last = tech_name_last;
    }

    public long getWrokingDays() {
        return wrokingDays;
    }

    public void setWrokingDays(long wrokingDays) {
