...
public class Avatar extends AppCompatImageView {
    ...
    private void getAttributes(AttributeSet attrs) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                com.cometchat.pro.uikit.R.styleable.Avatar,
                0, 0);
        ...
        try {
             ...
             * */
            String avatarShape = a.getString(com.cometchat.pro.uikit.R.styleable.Avatar_avatar_shape);
            avatarUrl = a.getString(com.cometchat.pro.uikit.R.styleable.Avatar_avatar);
            borderColor =a.getColor(com.cometchat.pro.uikit.R.styleable.Avatar_border_color,Color.WHITE);
            borderWidth=a.getDimension(com.cometchat.pro.uikit.R.styleable.Avatar_border_width,1);
            ...
            if (avatarShape == null) {
                ...
                if (getContext().getString(com.cometchat.pro.uikit.R.string.rectangle).equalsIgnoreCase(avatarShape)) {
                    shape = RECTANGLE;
                } else {
                    shape = CIRCLE;
                }
    ...
    public void setScaleType(ScaleType scaleType) {
        if (scaleType != SCALE_TYPE) {
            throw new IllegalArgumentException(String.format(getResources().getString(com.cometchat.pro.uikit.R.string.scale_type_not_supported), scaleType));
        }
    }
    ...
    public void setAdjustViewBounds(boolean adjustViewBounds) {
        if (adjustViewBounds) {
            throw new IllegalArgumentException(getResources().getString(com.cometchat.pro.uikit.R.string.adjust_viewbound_not_supported));
        }
    }
    ...
    protected void init() {
        ...
        paint.setColor(getResources().getColor(com.cometchat.pro.uikit.R.color.colorPrimary));
        ...
        color = getResources().getColor(com.cometchat.pro.uikit.R.color.colorPrimary);
   ...
   private RectF calculateBounds() {
    ...
    private void setValues() {
        if (avatarUrl != null && !avatarUrl.isEmpty() && !avatarUrl.equals("http://34.223.228.22/52a363e725235501a0fc865f1f628006.jpg")) {
            if (context!=null) {
                Picasso.get().load(avatarUrl).placeholder(drawable).centerCrop().into(this);
            }
        } else {
            setImageDrawable(drawable);
        }
