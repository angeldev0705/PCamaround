package com.pcamarounds.utils.dot_progressbar;
...
public class DotProgressBar extends View {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        try {
            ...
            mDotRadius = typedArray.getDimension(R.styleable.DotProgressBar_dpb_dotRadius, 14);
            mGrowFactor = typedArray.getFloat(R.styleable.DotProgressBar_dpb_growFactor, 1.5f);
            mDotSpacing = typedArray.getDimension(R.styleable.DotProgressBar_dpb_dotSpacing, 12);
    ...
    private void createAnimation() {
        ...
        mAnimationListener = animation -> invalidate();
