...
import com.pcamarounds.databinding.ActivityImageSliderJobBinding;
...
public class ImageSliderJobActivity extends AppCompatActivity {
    private static final String TAG = "ImageSliderJobActivity";
    private ActivityImageSliderJobBinding binding;
    private Context context;
    private List<ImagesModel> mImagesModelList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_image_slider_job);
        context = this;
        initView();
    }
    private void initView() {
        ...
        mImagesModelList = ((List<ImagesModel>) getIntent().getExtras().getSerializable(AppConstants.LIST));
    ...
    static class ImageSliderAdapter extends PagerAdapter {
        ...
        private String user_id = "";
        String imageUrl = "";
        public ImageSliderAdapter(Context context, List<ImagesModel> images,String udi){
        ...
        public Object instantiateItem(ViewGroup view, int position){
            ...
            imageUrl = AppConstants.DEVICES_IMG +user_id+"/"+ images.get(position).getImage();
