...
public class PhotoFullPopupWindow extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate(R.layout.popup_photo_full_two, null), ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        tvDownload = (TextView) view.findViewById(R.id.tvdown);
        ...
        tvDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FileDownloader(mContext, imageUrl);
            }
        });
        ...
        if (bitmap != null) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                parent.setBackground(new BitmapDrawable(mContext.getResources(), PhotoConstants.fastblur(Bitmap.createScaledBitmap(bitmap, 50, 50, true))));// ));
            } else {
            ...
            Glide.with(ctx).asBitmap()
                    .load(imageUrl).error(R.color.shimmer).listener(new RequestListener<Bitmap>() {
                        @Override
                        ...
                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, DataSource dataSource, boolean isFirstResource) {
                            if (Build.VERSION.SDK_INT >= 16) {
                                parent.setBackground(new BitmapDrawable(mContext.getResources(), PhotoConstants.fastblur(Bitmap.createScaledBitmap(resource, 50, 50, true))));// ));
                            } else {
