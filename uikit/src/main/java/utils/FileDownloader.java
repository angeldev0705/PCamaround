...
public class FileDownloader {
    ...
    public FileDownloader(Context context, String downloadUrl, String filename, String orderid) {
        this.context = context;
        this.downloadUrl = downloadUrl;
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" +"Pcamaround");
                } else
               ...
               // outputFile = new File(apkStorage, downloadFileName+Utility.getCurrentTime()+".pdf");//Create Output file in Main File
                outputFile = new File(apkStorage,filesuffix+"Pcamaround.jpeg");//Create Output file in Main File
